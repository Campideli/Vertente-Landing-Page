    ...
    <section className="relative h-screen flex items-center justify-center text-center bg-white px-6">
       ...
       <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <a 
          ...
          className="inline-block bg-vertente-orange text-white font-bold text-lg py-4 px-10 rounded-lg shadow-lg hover:bg-orange-600 transition-transform transform hover:scale-105"
        >
